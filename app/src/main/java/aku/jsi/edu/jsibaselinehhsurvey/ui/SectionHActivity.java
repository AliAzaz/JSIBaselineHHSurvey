...
import aku.jsi.edu.jsibaselinehhsurvey.databinding.ActivitySectionHBinding;
...
public class SectionHActivity extends AppCompatActivity {
    ...
    private void setContentUI() {
        this.setTitle(R.string.sectionH);
...
//            MainApp.endActivity(this, this, EndingActivity.class, true, fc);
    ...
    private void SaveDraft() {
        JSONObject secH = GeneratorClass.getContainerJSON(bi.fldGrpSecH01, true);
        fc.setSecH(String.valueOf(secH));
    }

    private boolean formValidation() {
        return ValidatorClass.EmptyCheckingContainer(this, bi.fldGrpSecH01);
    }
