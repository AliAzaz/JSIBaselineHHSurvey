...
import aku.jsi.edu.jsibaselinehhsurvey.databinding.ActivitySectionABinding;
...
public class SectionAActivity extends AppCompatActivity {
    ...
    private void setContentUI() {
        this.setTitle(R.string.sectionA);
...
//                MainApp.stActivity(this, this, SectionBActivity.class, fc);
    ...
    private boolean UpdateDB() {
        ...
        try {
            ...
            Long longID = new CrudOperations(SectionAActivity.this, FormsDAO.class.getName(), "formsDao", "insertForm", fc).execute().get();
            ...
            if (longID != 0) {
                ...
                longID = new CrudOperations(SectionAActivity.this, FormsDAO.class.getName(), "formsDao", "updateForm", fc).execute().get();
                return longID == 1;
