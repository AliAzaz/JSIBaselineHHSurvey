...
@Entity(tableName = CONSTANTS.TABLE_MARRIED_WOMENS_DEATH)
public class MWDeathForms implements Serializable {

    @Ignore
    private final String _projectName = "JSI - Married Womens Death";
    ...
    @Ignore
    public MWDeathForms(MWDeathForms forms) {
