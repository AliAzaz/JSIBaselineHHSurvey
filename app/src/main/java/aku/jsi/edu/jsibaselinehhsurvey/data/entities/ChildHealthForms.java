...
@Entity(tableName = CONSTANTS.TABLE_CHILD_HEALTH)
public class ChildHealthForms implements Serializable {

    @Ignore
    private final String _projectName = "JSI - Child Health";
    ...
    @Ignore
    public ChildHealthForms(ChildHealthForms forms) {
