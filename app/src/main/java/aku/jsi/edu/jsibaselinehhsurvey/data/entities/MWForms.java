...
@Entity(tableName = CONSTANTS.TABLE_MARRIED_WOMENS)
public class MWForms implements Serializable {

    @Ignore
    private final String _projectName = "JSI - Married Womens";
