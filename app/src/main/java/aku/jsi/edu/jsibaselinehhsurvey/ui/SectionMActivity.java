...
public class SectionMActivity extends AppCompatActivity {
    ...
    private void setContentUI() {
        this.setTitle(R.string.sectionM);
...
//            MainApp.endActivity(this, this, EndingActivity.class, true, fc);
    ...
    private void SaveDraft() {
        JSONObject secM = GeneratorClass.getContainerJSON(bi.fldGrpSecM01, true);
        fc.setSecM(String.valueOf(secM));
    }

    private boolean formValidation() {
        return ValidatorClass.EmptyCheckingContainer(this, bi.fldGrpSecM01);
    }
